...
//			TODO futuro ajuste quando existe tabela COTAÇÃO;
			...
			multiplos.setPrecoSobreLucro(calculadoraFundamentalista.getPrecoSobreLucro(balancoDailyUpdate.getCotacao(), balancoDailyUpdate.getEmpresa().getQuantidade(), balancoDailyUpdate.getLucroLiquidoAnual()));
			multiplos.setPrecoSobreValorPatrimonial(calculadoraFundamentalista.getPrecoSobreValorPatrimonial(balancoDailyUpdate.getCotacao(), balancoDailyUpdate.getEmpresa().getQuantidade(), balancoDailyUpdate.getPatrimonioLiquido()));
		}catch(Exception e) {
//			TODO tratar: pensar como lidar com essa situação.
		}
